...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative bg-gradient-to-br from-red-50/30 via-gray-100/30 to-yellow-50/30 py-20">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8">
              <div className="text-center">
                <div className="bg-red-500 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-2">
