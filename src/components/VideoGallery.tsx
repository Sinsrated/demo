...
const VideoGallery = () => {
  ...
  const videos = [
    {
      id: 'aijCfUNuOY8',
      thumbnail: '/youtubes/photo9.jpg?auto=compress&cs=tinysrgb&w=800',
      title: 'Welcome to Bright Stars School',
      description: 'Take a virtual tour of our beautiful campus and facilities'
    },
    {
      id: '49cdAaaVvbg',
      thumbnail: '/youtubes/photo1.jpg?auto=compress&cs=tinysrgb&w=800',
      title: 'Classroom Learning Experience',
      description: 'See our innovative teaching methods in action'
    },
    {
      id: '5utg2mcPcNA',
      thumbnail: '/youtubes/photo3.jpg?auto=compress&cs=tinysrgb&w=800',
      title: 'Sports and Recreation',
      description: 'Students enjoying physical activities and sports'
    },
    {
      id: 'hUYzjGPeLhA',
      thumbnail: '/youtubes/photo6.jpg?auto=compress&cs=tinysrgb&w=800',
      title: 'Arts and Creativity',
      description: 'Exploring creativity through arts and crafts'
    },
    {
      id: 'BJBHpSYPfj0',
      thumbnail: '/youtubes/photo5.jpg?auto=compress&cs=tinysrgb&w=800',
      title: 'Science Laboratory',
      description: 'Hands-on science experiments and discoveries'
    },
    {
      id: 'zIgHuRc_PTY',
      thumbnail: '/youtubes/photo4.jpg?auto=compress&cs=tinysrgb&w=800',
  ...
  return (
    <section id="video-gallery" className="py-20 bg:gradient-to-br from-red-50 to-yellow-50 bg-red-500/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 bg-white rounded-2xl p-8 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Get to know Bright Stars School through this comprehensive introduction video</p>
          </div>
